...
library(dplyr)
set.seed(1234)
setwd("/data/R02/nieyg/project/Maternal_scRNA/03_Z4")
...
Maternal.integrated<- readRDS("./01_All_celltype/Maternal_integrated_Z4.rds")
...
DefaultAssay(Maternal.integrated)<-"RNA"
pdf("./01_All_celltype/Z4_cluster-annotation-all_celltype.pdf",width=16,height=8)
...
pdf("./01_All_celltype/Z4_Maternal_cluster-tree-cosine.pdf",width=6,height=6)
...
combined$Annotation<-factor(combined$Annotation,levels=c("CM",'EC','FB','SMC','Epi','MP','T','B','Pericyte','Glial'))
...
pdf("./01_All_celltype/Z4_Annotated_allcelltype_UMAP.pdf",width=15,height=5)
...
cell.prop$celltype<- factor(cell.prop$celltype,levels=c("CM",'EC','FB','SMC','Epi','MP','T','B','Pericyte','Glial'))

pdf("./01_All_celltype/Z4_Annotated_allcelltype_proportion.pdf",width=4,height=5)
...
guides(fill=guide_legend(title=NULL))+
  scale_fill_manual(values = myUmapcolors[1:10]) 
dev.off()

# Save rds have annotation information 
DefaultAssay(combined) <- "RNA"
saveRDS(combined,"./01_All_celltype/Maternal_Z4_integrated_annotated.rds")
...
pdf("./01_All_celltype/Z4_cluster-annotated-dotplot.pdf",width=10,height=5)
...
write.csv(markers,"./01_All_celltype/FindAllMarkers_celltypes.csv")
...
pdf("./01_All_celltype/Allcelltype_top_markers-DEG_heatmap.pdf",width=10,height=10)
...
Pericyte<-markers[markers$cluster=="Pericyte",7]
...
DEG_list<- list(CM,EC,FB,SMC,Epi,MP,T,B,Pericyte,Glial)
subtype<- c("CM",'EC','FB','SMC','Epi','MP','T','B','Pericyte','Glial')

all_ego<- data.frame()
pdf("./01_All_celltype/All_celltype_DEG_GO_BP.pdf")
...
write.csv(all_ego,"./01_All_celltype/All_celltype_DEG_GO_BP.csv")
...
pdf("./01_All_celltype/All_celltype_DEG_GO_BP_top5.pdf",width=14,height=20)
...
pdf('./01_All_celltype/All_Marker_gene_FeaturePlot_uamp.pdf', width=5.5, height=5)
